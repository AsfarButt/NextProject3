...
export default function Camera(){
    ...
    return(<div className="fixed top-0 w-full h-full flex justify-center items-center overflow-hidden">
        <div className="relative w-[90%] max-w-260 h-auto flex justify-center items-center transition-tranform duration-1500" ref={camera}>
            <img src="/camera2.png" alt="Main Camera" className="relative w-full h-full z-10" />
